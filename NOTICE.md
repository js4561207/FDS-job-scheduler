...
This repository contains an independent Windows desktop scheduler for local
FDS jobs. It is not an official NIST product and is not affiliated with or
endorsed by the FDS/Smokeview development team.
...
- local calculation cases and generated result files
- local scheduler state, logs, and packaged binaries
